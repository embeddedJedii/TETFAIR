...
void GUI_event__Button__Set_ParametersAutoMode__Button_3__Clicked(lv_event_t *event) {
    lv_obj_add_state(GUI_Button__Set_ParametersAutoMode__Button_3, LV_STATE_CHECKED);   // Modify_State
    lv_obj_clear_state(GUI_Button__Set_ParametersAutoMode__Button_4, LV_STATE_CHECKED); // Modify_State
    lv_obj_clear_state(GUI_Button__Set_ParametersAutoMode__Button_6, LV_STATE_CHECKED); // Modify_State
    lv_obj_clear_state(GUI_Button__Set_ParametersAutoMode__Button_5, LV_STATE_CHECKED); // Modify_State
}

void GUI_event__Button__Set_ParametersAutoMode__Button_4__Clicked(lv_event_t *event) {
    lv_obj_add_state(GUI_Button__Set_ParametersAutoMode__Button_4, LV_STATE_CHECKED);   // Modify_State
    lv_obj_clear_state(GUI_Button__Set_ParametersAutoMode__Button_3, LV_STATE_CHECKED); // Modify_State
    lv_obj_clear_state(GUI_Button__Set_ParametersAutoMode__Button_5, LV_STATE_CHECKED); // Modify_State
    lv_obj_clear_state(GUI_Button__Set_ParametersAutoMode__Button_6, LV_STATE_CHECKED); // Modify_State
}

void GUI_event__Button__Set_ParametersAutoMode__Button_5__Clicked(lv_event_t *event) {
    lv_obj_add_state(GUI_Button__Set_ParametersAutoMode__Button_5, LV_STATE_CHECKED);   // Modify_State
    lv_obj_clear_state(GUI_Button__Set_ParametersAutoMode__Button_3, LV_STATE_CHECKED); // Modify_State
    lv_obj_clear_state(GUI_Button__Set_ParametersAutoMode__Button_4, LV_STATE_CHECKED); // Modify_State
    lv_obj_clear_state(GUI_Button__Set_ParametersAutoMode__Button_6, LV_STATE_CHECKED); // Modify_State
}

void GUI_event__Button__Set_ParametersAutoMode__Button_6__Clicked(lv_event_t *event) {
    lv_obj_add_state(GUI_Button__Set_ParametersAutoMode__Button_6, LV_STATE_CHECKED);   // Modify_State
    lv_obj_clear_state(GUI_Button__Set_ParametersAutoMode__Button_3, LV_STATE_CHECKED); // Modify_State
    lv_obj_clear_state(GUI_Button__Set_ParametersAutoMode__Button_4, LV_STATE_CHECKED); // Modify_State
    lv_obj_clear_state(GUI_Button__Set_ParametersAutoMode__Button_5, LV_STATE_CHECKED); // Modify_State
}
